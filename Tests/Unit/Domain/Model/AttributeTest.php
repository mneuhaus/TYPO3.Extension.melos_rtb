...
/**
 * Test case for class \Famelo\MelosRtb\Domain\Model\Attribute.
 *
...
class AttributeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Famelo\MelosRtb\Domain\Model\Attribute
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Famelo\MelosRtb\Domain\Model\Attribute();
	}
	...
	public function setArticleForArticleSetsArticle() {
		$articleFixture = new \Famelo\MelosRtb\Domain\Model\Article();
