...
CREATE TABLE tx_melosrtb_domain_model_application (
	...
	component_uses int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_melosrtb_domain_model_componentuse'
#
CREATE TABLE tx_melosrtb_domain_model_componentuse (
	...
	application int(11) unsigned DEFAULT '0',
