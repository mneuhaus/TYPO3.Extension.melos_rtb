...
$GLOBALS['TCA']['tx_melosrtb_domain_model_article'] = array(
	...
	'columns' => array(
		...
		'code' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:melos_rtb/Resources/Private/Language/locallang_db.xlf:tx_melosrtb_domain_model_article.code',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'sorting' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:melos_rtb/Resources/Private/Language/locallang_db.xlf:tx_melosrtb_domain_model_article.sorting',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
